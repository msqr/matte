 ...
 * 02111-1307 USA
 * ===================================================================
 * $Id: RegistrationKeyGenerationMode.java,v 1.1 2006/06/03 22:26:17 matt Exp $
 * ===================================================================
 */
...
/**
 * GeRDAL GenerationMode for registration keys.
 * 
 ...
 */
public class RegistrationKeyGenerationMode
	...
	throws Exception 
{
	...
	Registration reg = (Registration)row;
	String key = reg.getUsername()+new Date().toString()+Math.random();
