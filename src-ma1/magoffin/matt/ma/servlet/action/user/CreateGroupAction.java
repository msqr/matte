 ...
 * 
 * Created Jan 22, 2004 5:26:34 PM
 * 
 ...
 * 02111-1307 USA
 * ===================================================================
 * $Id: CreateGroupAction.java,v 1.1 2006/06/03 22:26:18 matt Exp $
 * ===================================================================
 */
	...
	throws Exception 
{
	...
	Group group = userBiz.createGroup(name,usd.getUser());
	
	addActionMessage(request,ActionMessages.GLOBAL_MESSAGE,
			new ActionMessage("create.group.created",group.getName()));
