 ...
 * 02111-1307 USA
 * ===================================================================
 * $Id: UserForm.java,v 1.5 2007/07/13 23:17:22 matt Exp $
 * ===================================================================
 */
 ...
 * @version $Revision: 1.5 $ $Date: 2007/07/13 23:17:22 $
 */
	...
	protected ModelAndView onSubmit(HttpServletRequest request,
		...
		if ( isNew ) {
			msg = new DefaultMessageSourceResolvable(
				new String[] {"add.user.success"}, 
				new Object[]{savedUser.getName()},
				"The user has been added.");
		} else {
			msg = new DefaultMessageSourceResolvable(
				new String[] {"update.user.success"}, 
				new Object[]{savedUser.getName()},
