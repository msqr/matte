 ...
 * 02111-1307 USA
 * ===================================================================
 * $Id: MimeTypeMediaHandlerDelegate.java,v 1.2 2007/07/28 10:25:54 matt Exp $
 * ===================================================================
 */
...
/**
 * Implementation of {@link MediaHandlerDelegate} that uses a MIME type 
 * mapping to delegate to any number of different {@link MediaHandlerDelegate}
 * implementations.
 * 
 ...
 *   {@link MediaHandlerDelegate} implementations to handle requests of that
 *   MIME type. The {@link #handleDelegateMediaRequest} method will look
 *   up MIME types in this map and delegate to the matching handler.</dd>
 * </dl>
 * 
...
public class MimeTypeMediaHandlerDelegate implements MediaHandlerDelegate {
	 ...
	 */
	public void handleDelegateMediaRequest(Resource mediaResource,
			String mimeType, MediaItem item, MediaRequest request,
			MediaResponse response) {
		MediaHandlerDelegate delegate = getDelegateMap().get(mimeType);
		if ( delegate == null ) {
			throw new UnsupportedOperationException("The MIME type [" +mimeType 
					+"] is not supported");
		}
	...
	/**
	 * @param delegateMap the delegateMap to set
	 */
