/* ===================================================================
 * InviteFriendAction.java
 * 
 * Created Jan 20, 2004 5:40:31 PM
 * 
 ...
 * 02111-1307 USA
 * ===================================================================
 * $Id: InviteFriendAction.java,v 1.1 2006/06/03 22:26:18 matt Exp $
 * ===================================================================
 */
...
/**
 * Action to invite a user to be a friend.
 * 
 * @author Matt Magoffin (spamsqr@msqr.us)
 * @version $Revision: 1.1 $ $Date: 2006/06/03 22:26:18 $
 */
public class InviteFriendAction extends AbstractAction {
	...
	throws Exception 
{
	...
	String email = (String)dForm.get(ServletConstants.REQ_KEY_EMAIL);
	
	URL accept = RequestUtils.absoluteURL(request,mapping.findForward("accept").getPath());
	URL decline = RequestUtils.absoluteURL(request,mapping.findForward("decline").getPath());
	
	UserBiz userBiz = (UserBiz)getBiz(BizConstants.USER_BIZ);
	userBiz.inviteFriend(email,usd.getUser(),accept,decline);
	
	addActionMessage(request,ActionMessages.GLOBAL_MESSAGE,
			new ActionMessage("invite.friend.sent",email));
