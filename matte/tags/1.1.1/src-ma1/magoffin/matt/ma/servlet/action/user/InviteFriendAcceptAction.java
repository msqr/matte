/* ===================================================================
 * InviteFriendAcceptAction.java
 * 
 * Created Jan 21, 2004 2:28:05 PM
 * 
 ...
 * 02111-1307 USA
 * ===================================================================
 * $Id: InviteFriendAcceptAction.java,v 1.1 2006/06/03 22:26:18 matt Exp $
 * ===================================================================
 */
 ...
 */
public class InviteFriendAcceptAction extends AbstractAction {
	...
	throws Exception 
{
	...
	User friend = userBiz.confirmInvitation(key);
	
	// add message that friends now
	this.addActionMessage(request,ActionMessages.GLOBAL_MESSAGE,
			new ActionMessage("invite.confirmed",friend.getName()));
