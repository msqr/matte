/* ===================================================================
 * RegisterSaveAction.java
 * 
 * Created Jan 22, 2004 9:25:17 AM
 * 
 ...
 * 02111-1307 USA
 * ===================================================================
 * $Id: RegisterSaveAction.java,v 1.1 2006/06/03 22:26:17 matt Exp $
 * ===================================================================
 */
...
/**
 * Action to save a registration.
 * 
 * @author Matt Magoffin (spamsqr@msqr.us)
 * @version $Revision: 1.1 $ $Date: 2006/06/03 22:26:17 $
 */
public class RegisterSaveAction extends AbstractAction {
	...
	throws Exception 
{
	...
	userBiz.register(regForm.getReg(),accept,decline);
	
	request.setAttribute("email",regForm.getReg().getEmail());
