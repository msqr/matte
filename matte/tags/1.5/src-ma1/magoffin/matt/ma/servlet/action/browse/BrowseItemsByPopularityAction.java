/* ===================================================================
 * BrowseItemsByPopularityAction.java
 * 
 * Copyright (c) 2004 Matt Magoffin. Created Mar 4, 2004 3:57:09 PM.
 * 
 ...
 * 02111-1307 USA
 * ===================================================================
 * $Id: BrowseItemsByPopularityAction.java,v 1.1 2006/06/03 22:26:18 matt Exp $
 * ===================================================================
 */
...
/**
 * Browse an album collection with a "virutal" view by popularity (hits).
 * 
 * @author Matt Magoffin (spamsqr@msqr.us)
 * @version $Revision: 1.1 $ $Date: 2006/06/03 22:26:18 $
 */
public class BrowseItemsByPopularityAction extends AbstractBrowseAction 
{
/* (non-Javadoc)
...
protected void goBrowse(ActionMapping mapping, BrowseAlbumsForm form,
		...
		ActionResult result, BrowseData data, AlbumTheme theme, UserSessionData usd, User browseUser)
		throws Exception 
{
	basicGoBrowse(mapping,form,request,response,result,data,theme,usd,
			browseUser,UserBiz.VIRTUAL_VIEW_MODE_POPULARITY);
}
