/* ===================================================================
 * PermissionsPKImpl.java
 * 
 * Created Jan 6, 2004 3:31:46 PM
 * 
 ...
 * 02111-1307 USA
 * ===================================================================
 * $Id: PermissionsPKImpl.java,v 1.1 2006/06/03 22:26:16 matt Exp $
 * ===================================================================
 */
...
/**
 * Permissions primary key implementation using GeRDAL.
 * 
 * @author Matt Magoffin (spamsqr@msqr.us)
 * @version $Revision: 1.1 $ $Date: 2006/06/03 22:26:16 $
 */
public class PermissionsPKImpl
extends AbstractGeRDALPK
implements PermissionsPK 
{
...
/* (non-Javadoc)
 * @see magoffin.matt.ma.dao.PermissionsPK#getUserId()
 */
...
/* (non-Javadoc)
 * @see magoffin.matt.ma.dao.PermissionsPK#setUserId(java.lang.Object)
 */
