 ...
 * 
 * Created Jan 22, 2004 6:10:17 PM
 * 
 ...
 * 02111-1307 USA
 * ===================================================================
 * $Id: DeleteGroupAction.java,v 1.1 2006/06/03 22:26:18 matt Exp $
 * ===================================================================
 */
	...
	throws Exception 
{
	...
	Group group = userBiz.deleteGroup(id,usd.getUser());
	
	addActionMessage(request,ActionMessages.GLOBAL_MESSAGE,
			new ActionMessage("delete.group.deleted",group.getName()));
