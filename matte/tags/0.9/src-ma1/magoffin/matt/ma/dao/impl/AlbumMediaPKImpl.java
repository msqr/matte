/* ===================================================================
 * AlbumMediaPKImpl.java
 * 
 * Created Dec 27, 2003 4:43:33 PM
 * 
 ...
 * 02111-1307 USA
 * ===================================================================
 * $Id: AlbumMediaPKImpl.java,v 1.1 2006/06/03 22:26:16 matt Exp $
 * ===================================================================
 */
...
/**
 * Album media primary key implementation using GeRDAL.
 * 
 * @author Matt Magoffin (spamsqr@msqr.us)
 * @version $Revision: 1.1 $ $Date: 2006/06/03 22:26:16 $
 */
public class AlbumMediaPKImpl
	extends AbstractGeRDALPK
	implements AlbumMediaPK 
{
...
/* (non-Javadoc)
 * @see magoffin.matt.ma.dao.AlbumMediaPK#getId()
 */
public Object getId() {
	return getKey();
}
...
/* (non-Javadoc)
 * @see magoffin.matt.ma.dao.AlbumMediaPK#setId(java.lang.Object)
 */
