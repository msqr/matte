 ...
 * 02111-1307 USA
 * ===================================================================
 * $Id: CreateAlbumStartAction.java,v 1.1 2006/06/03 22:26:18 matt Exp $
 * ===================================================================
 */
...
/**
 * Action to allow user to create a new album.
 * 
 * <p> Created on Dec 5, 2002 4:57:49 PM.</p>
 *
 * @author Matt Magoffin (spamsqr@msqr.us)
 */
public class CreateAlbumStartAction extends AbstractAction 
{
...
throws Exception 
{
	...
	Album[] albums = userBiz.getAlbumsOwnedByUser(usd.getUser().getUserId());
