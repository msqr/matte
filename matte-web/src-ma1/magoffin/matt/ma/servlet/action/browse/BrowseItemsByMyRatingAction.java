/* ===================================================================
 * BrowseItemsByMyRatingAction.java
 * 
 * Created Jul 27, 2004 8:12:42 AM
 * 
 ...
 * 02111-1307 USA
 * ===================================================================
 * $Id: BrowseItemsByMyRatingAction.java,v 1.1 2006/06/03 22:26:18 matt Exp $
 * ===================================================================
 */
...
/**
 * Action to browse media items by virtual acting user rating view.
 * 
 * @author Matt Magoffin (spamsqr@msqr.us)
 * @version $Revision: 1.1 $ $Date: 2006/06/03 22:26:18 $
 */
public class BrowseItemsByMyRatingAction extends AbstractBrowseAction {
		...
		UserSessionData usd, User browseUser) throws Exception 
{
	basicGoBrowse(mapping,form,request,response,result,data,theme,usd,
			browseUser,UserBiz.VIRTUAL_VIEW_MODE_MY_RATING);
}
