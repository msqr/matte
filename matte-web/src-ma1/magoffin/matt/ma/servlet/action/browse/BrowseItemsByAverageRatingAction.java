/* ===================================================================
 * BrowseItemsByAverageRatingAction.java
 * 
 * Created Feb 24, 2004 9:51:22 AM
 * 
 ...
 * 02111-1307 USA
 * ===================================================================
 * $Id: BrowseItemsByAverageRatingAction.java,v 1.1 2006/06/03 22:26:18 matt Exp $
 * ===================================================================
 */
...
/**
 * Action to browse media items by virtual average rating view.
 * 
 * @author Matt Magoffin (spamsqr@msqr.us)
 * @version $Revision: 1.1 $ $Date: 2006/06/03 22:26:18 $
 */
public class BrowseItemsByAverageRatingAction extends AbstractBrowseAction
{
/* (non-Javadoc)
...
protected void goBrowse(ActionMapping mapping, BrowseAlbumsForm form,
		...
		ActionResult result, BrowseData data, AlbumTheme theme, UserSessionData usd, 
		User browseUser)
		throws Exception
{
	basicGoBrowse(mapping,form,request,response,result,data,theme,usd,
			browseUser,UserBiz.VIRTUAL_VIEW_MODE_AVERAGE_RATING);
}
