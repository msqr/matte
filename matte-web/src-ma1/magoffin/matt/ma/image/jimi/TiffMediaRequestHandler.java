 ...
 * 02111-1307 USA
 * ===================================================================
 * $Id: TiffMediaRequestHandler.java,v 1.1 2006/06/03 22:26:19 matt Exp $
 * ===================================================================
 */
...
/**
 * MediaRequestHandler implementation for reading TIFF images but writing them
 * out as JPEG.
 * 
 * <p>Created Dec 8, 2002 07:04:37 PM.</p>
 * 
 * @author Matt Magoffin (spamsqr@msqr.us)
 */
public class TiffMediaRequestHandler extends JimiMediaRequestHandler 
{
	
	private static final Logger log = Logger.getLogger(TiffMediaRequestHandler.class);
