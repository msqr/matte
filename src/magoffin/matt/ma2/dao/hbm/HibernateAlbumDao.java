...
implements AlbumDao {
	...
	public static final String QUERY_ALBUMS_FOR_USER_ID_AND_NAME 
		= "AlbumsForUserIdAndName";
	
	/** Find all Albums for a User ID, sorted by date in descending order. */
	public static final String QUERY_ALBUMS_FOR_USER_ID_BY_DATE 
		= "AlbumsForUserIdByDate";
	
	/** 
	 * Find all Albums for a User ID with 'allowAnonymous' = TRUE, 
	 * sorted by date in descending order. 
	 */
	public static final String QUERY_ALBUMS_FOR_USER_ID_FOR_ANONYMOUS_BY_DATE
		= "AlbumsForUserIdForAnonymousByDate";
	
	/** 
	 * Find all Albums for a User ID with 'allowBrowse' = TRUE, 
	 * sorted by date in descending order. 
	 */
	public static final String QUERY_ALBUMS_FOR_USER_ID_FOR_BROWSE_BY_DATE
		= "AlbumsForUserIdForBrowseByDate";
	
	/** 
	 * Find all Albums for a User ID with 'allowFeed' = TRUE, 
	 * sorted by date in descending order. 
	 */
	public static final String QUERY_ALBUMS_FOR_USER_ID_FOR_FEED_BY_DATE 
		= "AlbumsForUserIdForFeedByDate";
	
	/** 
	 * Find album search results for a User ID with 'allowFeed' = TRUE, 
	 * sorted by date in descending order. 
	 */
	public static final String SEARCH_ALBUMS_FOR_USER_ID_FOR_FEED_BY_DATE 
		= "AlbumSearchResultsForUserIdForFeedByDate";
	
	/** 
	 * Find all Albums for a User ID, sorted by date in descending order, 
	 * newer than a given date. 
	 */
	public static final String QUERY_ALBUMS_FOR_USER_ID_BY_DATE_SINCE 
		= "AlbumsForUserIdByDateSince";
	 ...
	 */
	public static final String QUERY_SHARED_ALBUMS_FOR_MEDIA_ITEM 
		= "AlbumsForMediaItem";
	
	/** 
	 * Find the parent Album for a given Album. 
	 */
	public static final String QUERY_PARENT_ALBUM_FOR_ALBUM 
		= "AlbumParentForAlbum";
	...
	/* (non-Javadoc)
	 * @see magoffin.matt.ma2.dao.AlbumDao#findAlbumsForUser(java.lang.Long)
	 */
	...
	/* (non-Javadoc)
	 * @see magoffin.matt.ma2.dao.AlbumDao#findAlbumsForUserAndName(java.lang.Long, java.lang.String)
	 */
	...
	/* (non-Javadoc)
	 * @see magoffin.matt.ma2.dao.AlbumDao#getParentAlbum(java.lang.Long)
	 */
	...
	/* (non-Javadoc)
	 * @see magoffin.matt.ma2.dao.AlbumDao#findSharedAlbumsContainingItem(magoffin.matt.ma2.domain.MediaItem)
	 */
	...
	/* (non-Javadoc)
	 * @see magoffin.matt.ma2.dao.AlbumDao#findAlbumsForUserByDate(java.lang.Long, java.util.Calendar, boolean, boolean, boolean)
	 */
	public List<Album> findAlbumsForUserByDate(Long userId, Calendar since, 
	...
	/* (non-Javadoc)
	 * @see magoffin.matt.ma2.dao.AlbumDao#findAlbumsForUserByDate(java.lang.Long, int, boolean, boolean)
	 */
	public List<Album> findAlbumsForUserByDate(Long userId, int max, 
			boolean anonymousOnly, boolean browseOnly, boolean feedOnly) {
		Map<String, Object> params = new LinkedHashMap<String, Object>();
		params.put(QUERY_PARAM_USER_ID, userId);
		String queryName = feedOnly
	...
	/* (non-Javadoc)
	 * @see magoffin.matt.ma2.dao.AlbumDao#getAlbumForKey(java.lang.String)
	 */
	public Album getAlbumForKey(String anonymousKey) {
		List<Album> results = findByNamedQuery(QUERY_ALBUM_FOR_KEY, 
				new Object[] {anonymousKey});
		if ( results.size() < 1 ) return null;
		return results.get(0);
	}

	/* (non-Javadoc)
	 * @see magoffin.matt.ma2.dao.AlbumDao#getAlbumWithItems(java.lang.Long)
	 */
	...
	/* (non-Javadoc)
	 * @see magoffin.matt.ma2.dao.AlbumDao#reassignAlbumsUsingTheme(magoffin.matt.ma2.domain.Theme, magoffin.matt.ma2.domain.Theme)
	 */
	public int reassignAlbumsUsingTheme(final Theme oldTheme, final Theme newTheme) {
		return (Integer) getHibernateTemplate().execute(new HibernateCallback() {
			public Object doInHibernate(Session session) 
			throws HibernateException, SQLException {
				ScrollableResults albums = session.getNamedQuery(
						QUERY_ALBUMS_FOR_THEME_ID)
					.setLong("themeId", oldTheme.getThemeId())
