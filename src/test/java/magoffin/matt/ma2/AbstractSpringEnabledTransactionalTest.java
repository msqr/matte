...
/**
 * Extension of Spring's AbstractTransactionalDataSourceSpringContextTests with
...
@ContextConfiguration(locations = { "classpath:magoffin/matt/ma2/TestContext.xml",
		...
		"file:src/main/webapp/WEB-INF/dataAccessContext.xml", "classpath:testContext.xml", })
...
public abstract class AbstractSpringEnabledTransactionalTest
	...
	public void onSetUpInTransaction() {
		...
		int rowCount = this.simpleJdbcTemplate
				.update("UPDATE " + TestConstants.TABLE_THEMES + " SET owner_ = NULL");
		if ( logger.isInfoEnabled() ) {
			logger.info("Updated " + rowCount + " rows from table " + TestConstants.TABLE_THEMES);
		}
