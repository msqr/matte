	...
	<xsl:template match="x:x-data">
		...
		<html>
			<head>
				...
				<script type="text/javascript" src="{$web-context}/js/xslt/xmltoken.js"><xsl:text> </xsl:text></script>
				<script type="text/javascript" src="{$web-context}/js/xslt/util.js"><xsl:text> </xsl:text></script>
