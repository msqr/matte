 ...
 * @version 1.1
 */
public class HibernateMediaItemDao extends GenericHibernateDao<MediaItem, Long> implements MediaItemDao {
	...
	public static final String QUERY_MEDIA_ITEMS_OF_COLLECTION_FOR_ALBUM = "MediaItemsAndAlbumsForCollection";

	private String removeItemsFromAlbumsQuery = "select MediaItem, Album from magoffin.matt.ma2.domain.MediaItem MediaItem, "
			+ "magoffin.matt.ma2.domain.Album Album " + "where MediaItem in elements(Album.Item) "
			+ "and MediaItem.id in ({0})";

	private String removeItemsFromCollectionsQuery = "select MediaItem, Collection from magoffin.matt.ma2.domain.MediaItem MediaItem, "
			+ "magoffin.matt.ma2.domain.Collection Collection "
			+ "where MediaItem in elements(Collection.Item) " + "and MediaItem.id in ({0})";
	...
	public List<MediaItem> removeItemsOfCollectionFromAlbums(Long collectionId) {
		List<Object[]> queryResults = getHibernateTemplate()
				.findByNamedQuery(QUERY_MEDIA_ITEMS_OF_COLLECTION_FOR_ALBUM, collectionId);
		return removeItemsFromAlbums(queryResults);
	}
	...
	private BatchResult handleBatchIndex(BatchCallback<MediaItem> callback, BatchOptions batchOptions) {
	...
	/**
	 * @param removeItemsFromAlbumsQuery
	 *        The removeItemsFromAlbumsQuery to set.
	 */
	...
	/**
	 * @param removeItemsFromCollectionsQuery
	 *        the removeItemsFromCollectionsQuery to set
	 */
	protected void setRemoveItemsFromCollectionsQuery(String removeItemsFromCollectionsQuery) {
