 ...
 * 
 * <p>
 * This interceptor serves as a base for email interceptors using templated
 * email content (mail merge). The {@link #invoke(MethodInvocation)} method
 * performs the following steps:
 * </p>
 * 
 * <ol>
 * <li>Calls {@link #getInitialModel(MethodInvocation)}. This method must return
 * a non-null Map to use for the model data for the mail merge.</li>
 * 
 * <li>Calls {@link MethodInvocation#proceed()}.</li>
 * 
 * <li>Calls {@link #postProcessModel(MethodInvocation, Map, Object)}, passing
 * the model Map previously returned and the result of the method
 * invocation.</li>
 * 
 * <li>Calls {@link #getLocale(MethodInvocation, Map, Object)}.</li>
 * 
 * <li>Calls
 * {@link magoffin.matt.ma2.util.MailMergeHelper#sendMerge(Locale, ClassLoader, Map, SimpleMailMessage)}
...
public abstract class AbstractMailTemplateInterceptor implements MethodInterceptor {
	 ...
	 * 
	 * <p>
	 * This implementation simply returns {@link Locale#getDefault()}. Extending
	 * implementations can use the invocation and invocation result to provide a
	 * custom Locale as deisred.
	 * </p>
	 * 
	 * @param invocation
	...
	/**
	 * Get a SimpleMailMessage object based on the result of the method
	 * invocation.
	 * 
	 * <p>
	 * You can use the MailMergeHelper instance's
	 * {@link MailMergeHelper#getMessageTemplate()} method to obtain a mail
	 * message template, and use the
	 * {@link SimpleMailMessage#SimpleMailMessage(org.springframework.mail.SimpleMailMessage)}
	 * copy constructor to create the SimpleMailMessage to return here. Most
	 * likely the only property you'll need to set on the result if the
	 * <code>to</code> property.
	 * </p>
	 * 
	 * @param invocation
	 *        the current method invocation
	 ...
	 * @return a SimpleMailMessage object with appropriate information set, i.e.
	 *         the <code>to</code> property
	 */
